...
/// <summary>
/// Базовый класс для компонентов, реализующих INetworkRunnerCallbacks
/// Предоставляет пустые реализации всех методов интерфейса
/// </summary>
public abstract class NetworkCallbackBase : LoggableMonoBehaviour, INetworkRunnerCallbacks
{
